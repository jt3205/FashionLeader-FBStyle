...
var _temp3 = function () {
    ...
    __REACT_HOT_LOADER__.register(_express2, '_express2', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(_webpackDevServer2, '_webpackDevServer2', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(_webpack2, '_webpack2', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(_posts2, '_posts2', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(_interopRequireDefault, '_interopRequireDefault', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(app, 'app', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(port, 'port', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(devPort, 'devPort', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(compiler, 'compiler', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(devServer, 'devServer', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(server, 'server', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(_temp, '_temp', 'dist2/dist/server/main.js');

    __REACT_HOT_LOADER__.register(_temp2, '_temp2', 'dist2/dist/server/main.js');
}();
