...
var _temp2 = function () {
    ...
    __REACT_HOT_LOADER__.register(update, 'update', 'dist2/src/process.js');

    __REACT_HOT_LOADER__.register(getContents, 'getContents', 'dist2/src/process.js');

    __REACT_HOT_LOADER__.register(getClothes, 'getClothes', 'dist2/src/process.js');

    __REACT_HOT_LOADER__.register(summary, 'summary', 'dist2/src/process.js');

    __REACT_HOT_LOADER__.register(_temp, '_temp', 'dist2/src/process.js');
}();
