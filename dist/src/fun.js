...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(getContents, 'getContents', 'src/fun.js');

    __REACT_HOT_LOADER__.register(getClothes, 'getClothes', 'src/fun.js');

    __REACT_HOT_LOADER__.register(summary, 'summary', 'src/fun.js');
}();
