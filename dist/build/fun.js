...
var _temp2 = function () {
    ...
    __REACT_HOT_LOADER__.register(getContents, 'getContents', 'build/fun.js');

    __REACT_HOT_LOADER__.register(getClothes, 'getClothes', 'build/fun.js');

    __REACT_HOT_LOADER__.register(summary, 'summary', 'build/fun.js');

    __REACT_HOT_LOADER__.register(_temp, '_temp', 'build/fun.js');
}();
